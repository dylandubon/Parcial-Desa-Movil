...
import 'package:flutter/material.dart';
import 'package:movie/widgets/pets_slider.dart';
...
class _MedicalRecordFormState extends State<MedicalRecordForm> {
  ...
  final List<Pet> _medicalRecords = [];

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Pet Medical Records'),
      ),
      body: Padding(
              ...
              onPressed: () {
                setState(() {
                  ...
                  if (petName.isNotEmpty) {
                    _medicalRecords.add(Pet(petName));
                    _nameController.clear();
                  }
                });
              },
              child: Text('Registrar seguimiento médico'),
            ),
            SizedBox(height: 16),
